...
export enum EReduxAppAction {
  ...
  MERGE_TERRY_CHECKINS = 'MERGE_TERRY_CHECKINS',
  ...
  SET_CONVERSATION_STAT = 'SET_CONVERSATION_STAT',
  SET_CONVERSATIONS = 'SET_CONVERSATIONS',
  MERGE_CONVERSATIONS = 'MERGE_CONVERSATIONS',
  // To update conversation saved in redux store by id
  ...
  SET_NEARBY_PLAYER_LOCATION = 'SET_NEARBY_PLAYER_LOCATION',

  RESET_APP_STATES = 'RESET_APP_STATES',
}
export enum ESagaUserAction {
  ...
  DELETE_TERRY_CHECKINS = 'DELETE_TERRY_CHECKINS',
  UPDATE_TERRY_CHECKIN = 'UPDATE_TERRY_CHECKIN',
...
export enum ESagaAppAction {
  ...
  BUILDER_UPDATE_TERRY = 'BUILDER_UPDATE_TERRY',
  BUILDER_DELETE_TERRY = 'BUILDER_DELETE_TERRY',
  ...
  HUNTER_GET_CONVERSATION_BY_ID = 'HUNTER_GET_CONVERSATION_BY_ID',
  HUNTER_FILTER_CONVERSATION_STAT = 'HUNTER_FILTER_CONVERSATION_STAT',
