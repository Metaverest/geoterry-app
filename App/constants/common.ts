...
export const DEFAULT_LATITUTE_DELTA_THRESHOLD_TO_FETCH_TERRY = 0.7;

export const DEFAULT_LONGITUDE_DELTA_THRESHOLD_TO_FETCH_TERRY = 0.7;

export const LOCAL_MESSAGE_PREFIX = 'local-message-';

export const MAX_CONVERSATION_SNIPPET_LENGTH = 30;

export const CHATS_PAGINATION_PAGE_SIZE = 15;

export const CHAT_MESSAGES_PAGINATION_PAGE_SIZE = 15;

export const CHECKIN_HISTORY_PAGINATION_PAGE_SIZE = 15;

export const REVIEWS_PAGINATION_PAGE_SIZE = 15;
