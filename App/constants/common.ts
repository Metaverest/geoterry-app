...
export const MAX_CONVERSATION_SNIPPET_LENGTH = 40;

export const CHATS_PAGINATION_PAGE_SIZE = 20;

export const CHAT_MESSAGES_PAGINATION_PAGE_SIZE = 25;

export const CHECKIN_HISTORY_PAGINATION_PAGE_SIZE = 20;

export const REVIEWS_PAGINATION_PAGE_SIZE = 20;
